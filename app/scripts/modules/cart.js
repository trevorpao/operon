;(function (app, gee, $) {
    ...
    app.cart = {
        ...
        add2Cart: function (itemID, qty, type) {
            ...
            gee.yell('/cart/add', { qty: qty, item_id: itemID, type: type }, callback, callback);
        },
            ...
            var callback = function () {
                if (this.code !== '1') {
                    ...
                    if (this.data.cart.length > 0) {
                        ...
                        location.href = gee.mainUri;
                    }
                }
            };

            gee.yell('/cart/remove', { item_id: itemID }, callback, callback);
        },
    ...
    gee.hook('add2Cart', function (me) {
        ...
        app.cart.add2Cart(itemID, qty, 'normal');
    });
    ...
    gee.hook('changeQty', function (me) {
        ...
        app.cart.add2Cart(itemID, qty, 'force');
    });
